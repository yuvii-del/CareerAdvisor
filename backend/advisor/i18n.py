...
UI_STRINGS = {
    ...
    "ta": {
        ...
        "roadmap_beginner_bullets": (
            "அடிப்படைகளை கற்றுக்கொள்ளுதல்",
            "அடிப்படை நிரலாக்கம்",
            "முக்கிய கருத்துகள்",
        ),
        "roadmap_intermediate": "இடைநிலை",
        "roadmap_intermediate_desc": "திட்டங்கள் உருவாக்கி, framework கற்றுக் கொண்டு அனுபவம் பெறுங்கள்",
        "roadmap_intermediate_bullets": (
            "உண்மைத் திட்டங்கள்",
            "Framework மற்றும் தொழில் கருவிகள்",
            "Internship அல்லது குழு அனுபவம்",
        ),
        "roadmap_advanced": "மேம்பட்ட நிலை",
        "roadmap_advanced_desc": "சிறப்பு துறையில் கவனம், open source, மற்றவர்களுக்கு வழிகாட்டுதல்",
        "roadmap_advanced_bullets": (
            "ஆழமான சிறப்புத் துறை",
            "Open source மற்றும் பெரிய அமைப்புகள்",
            "வழிகாட்டுதல் மற்றும் தலைமை",
        ),
        "growth_timeline": " தொழில் வளர்ச்சி காலவரிசை",
        "download_report": " தொழில் அறிக்கையை பதிவிறக்கவும்",
